...
@InitiatedBy(QueryClaim.class)
public class QueryHamdlerClaim extends FlowLogic<Void> {
    ...
    public QueryHamdlerClaim(FlowSession session) {
    ...
    public Void call() throws FlowException {
        ...
        try {
            ...
            response = getServiceHub().cordaService(Oracle.class).query2(request);
        } catch (Exception e) {
